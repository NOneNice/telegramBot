export const PLEASE_LOGIN_TO_GAIN_ACCESS =
  'Пройдите авторизацию для получения доступа';
...
export const OrderClothes = 'Заказать одежду';
export const VIEW_BOOKED = 'Посмотреть заказы';
...
export const CHOOSE_ONE_OF_THE_SUGGESTED_ACTIONS =
  'Выберите одно из предложенных действий';

export const ADMIN_AUTHORIZATION_SUCCESSFULLY =
  'Добро пожаловать в средства администрирования, выберите действие';
